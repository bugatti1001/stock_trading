...
添加后系统会自动尝试拉取基础信息和实时数据。

![股票池管理](images/01_stocks.png)

股票列表中的「门槛」列（市值、PE、3Y、盈利）可以快速判断数据完整度。「来源」列显示数据来自 Finnhub、雪球还是 SEC。
...
首页仪表盘提供整体概览和 AI 选股建议。

![Dashboard](images/06_dashboard.png)

- 顶部卡片：股票池数量、投资原则数、AI 对话记录
- 中间图表：行业分布和市值分布
- 右下角「AI 选股建议」：AI 综合分析整个股票池，推荐 2-3 只当前最值得关注的股票，建议会结合最新新闻和你的投资原则
...
**Q：新闻获取为 0 条？**
A：非交易日或当天该股票暂无新闻属正常情况。美股需要 FINNHUB_API_KEY，A股/港股使用东方财富免费接口。
