...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        Args:
            ...
            progress_callback: Optional callable invoked before/after graph nodes run
        """
        self.debug = debug
        ...
        # Analyst LLM: use a cheaper/faster model for data analysis if configured
        analyst_model = self.config.get("analyst_llm")
        if analyst_model and analyst_model != self.config["quick_think_llm"]:
            ...
            self.analyst_llm = analyst_client.get_llm()
        else:
    ...
    def _get_provider_kwargs(self) -> Dict[str, Any]:
        ...
        # Pass max_tokens if specified in config
